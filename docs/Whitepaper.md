...
### 13.8 Performance Fee Allocation and Internal Use Limitations

The YieldLoop platform applies a performance-based fee equal to 20% of verified profit, calculated and charged only after execution concludes and settlement finality is reached.

Allocation of the performance fee is an internal protocol accounting matter and does not affect user vault balances, settlement outcomes, or redemption rights.

No portion of the performance fee creates an entitlement, expectation, or obligation to generate future profit, increase token value, or influence market behavior.

---

### 13.8.1 Allocation Categories

The 20% performance fee is allocated evenly across five internal categories. These allocations reflect operational budgeting decisions and may be adjusted, paused, or discontinued by governance without affecting user-facing protocol behavior.

#### Development & Operations (20%)

Supports protocol maintenance, infrastructure, security reviews, monitoring, documentation, and operational continuity.

This allocation does not imply ongoing development commitments or performance obligations.

---

#### Marketing & Ecosystem Growth (20%)

Supports educational materials, outreach initiatives, partnerships, community engagement, and ecosystem awareness.

Marketing allocation does not guarantee user growth, liquidity, or economic outcomes and is not tied to protocol performance metrics.

---

#### LoopLab (20%)

Allocated to research, experimentation, and documentation related to verification, settlement, transparency, and accounting methodologies.

LoopLab is a research and innovation initiative and does not:
- Manage user assets
- Provide investment services
- Influence protocol execution or settlement outcomes

---

#### System Deposit (20%)

Allocated to a protocol-owned system deposit deployed using the same execution, verification, and settlement rules as user deposits.

Key constraints:
- The system deposit does not receive preferential execution, information, or treatment
- The system deposit does not create obligations to generate profit
- Any verified profit generated by the system deposit is redeposited according to the same protocol rules
- The system deposit may be reduced, disabled, or withdrawn by governance without notice

The system deposit is not proprietary trading, asset management, or performance targeting. It exists solely to test, exercise, and sustain protocol mechanics under live conditions.

---

#### Floor Increase Fund (20%)

Allocated to a protocol-owned reserve intended to support redemption backing availability under defined conditions.

The Floor Increase Fund:
- Does not target token price, market value, or appreciation
- Does not guarantee redemption outcomes
- Does not imply a commitment to increase the redemption floor
- Operates exclusively through rule-based, non-discretionary logic

Use of the Floor Increase Fund is subject to:
- Settlement priority rules ensuring all user obligations are satisfied first
- Exposure caps and redeployment limits defined in Section 14A
- Automated rebalancing constraints to prevent excessive accumulation or overconcentration

The Floor Increase Fund is an accounting and risk-management mechanism, not a stabilization or price-support mechanism.

---

### 13.8.2 General Limitations and Disclosures

Performance fee allocation:
- Applies only when verified profit exists
- Creates no expectation of future outcomes
- Does not constitute discretionary asset management
- Does not alter protocol classification as non-custodial settlement infrastructure

All allocations are disclosed for transparency purposes and are observable on-chain or through auditable accounting records.

The existence or structure of performance fee allocations does not create an investment contract, profit expectation, or reliance on managerial efforts.
